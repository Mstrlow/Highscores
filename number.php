      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          ...
          <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="number.php">Suche nach Spielnummer - Funktioniert<span class="sr-only">(current)</span></a></li>
          </ul>
        </div>
              ...
              <div class="row">
                <div class="col-lg-4 right-offset-8">
                  <div class="input-group">
                    <input type="text" class="form-control" name="number" id="number" placeholder="<?php if(isset($_POST['number'])){echo $_POST['number'];}else{echo 'Spielnummer';} ?>">
